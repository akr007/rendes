<?php session_start(); ?>
    <?php
        ...
        include("footer.html");
    ?>
    <title>RendesWeb feladat</title>
</head>
<body>
    <div class="container">
        <h1>RendesWeb interjú feladat</h1>
        <p>A feladatok megoldását a jelentkezes@rendes.hu e-mail címre várjuk. Ha bármi instukció kell a megoldások futtatásához, akkor azt mindenképp mellékeld!
        ...
        <p>
        1.) Küldd el a megoldását a Project Euler 753. feladatának. Itt elég csak a p < 1 000 000 prímeket venni (szemben a feladatban leírt 6 000 000-val) <h6>NEM SIKERÜLT</h6>
        </p>
        <p>
